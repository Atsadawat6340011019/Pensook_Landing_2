  ...
  return (
    <>
      <ThemeProvider theme={Responsive}>
        <Box
          id="Partner-section"
          sx={{ marginTop: "auto", height: "80px", backgroundColor: "#F4FFFA" }}
        ></Box>
        <Box
          sx={{
            display: "flex",
            alignItems: "center",
            width: "100vw",
            height: {md:"115vh",lg:"120vh",xl:"115vh",xxl:"100vh"},
        ...
        >
          ...
          <Grid container spacing={2}>
            ...
            <Grid
              ...
              sx={{
                ...
                flexDirection: "column",
                mt: {md:"70vh",lg:"70vh",xl:"60vh",xxl:7},
          ...
          <Box
            sx={{
              position: "absolute",
              mt: {md:"110vh",lg:"115vh",xl:"110vh",xxl:"90vh"},
            }}
          >
