      ...
      <ThemeProvider theme={Responsive}>
        ...
        >
          ...
          >
            ...
            >
              เรามุ่งมั่นที่จะนำเสนอเทค    โนโลยีทางการแพทย์ที่
            </Typography>
            <Typography
              sx={{
                fontSize: windowWidth < 400 ? 14 : 16,
          ...
          <Typography
            sx={{
              ...
              color: "#065B85",
              display:"flex",
              flexDirection: windowWidth < 475 ? "column" : "row", 
    alignItems: "center",   
    justifyContent: "center", 
    textAlign: "center",
            }}className={noto_Sans_Thai.className}
          >
            ...
            <span style={{ color: '#007DFC' }}>ทันสมัยและมีความน่าเชื่อถือ</span> เพื่อเสริมสร้างการดูแลสุขภาพที่มีประสิทธิภาพ
          </Typography>
          </Box>
            ...
            >
              ...
              >
                ...
                <Grid xs={3} sx={{ pt: widthImageDispensing === 339 ? 15 : 5 }}>
                  <Box sx={{ ml: 2, height: windowWidth < 501 ? 350 : 400 }}>
                    <Image
