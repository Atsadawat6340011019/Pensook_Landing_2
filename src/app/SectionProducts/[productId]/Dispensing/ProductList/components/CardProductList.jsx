...
export default function CardProductList() {
  ...
  return (
    <>
      ...
      <Box
        sx={{ display: "flex",  width: "100%" , justifyContent:"center"  , flexDirection:{md:"column",lg:"row"},alignItems: "center",}}
      >
        <Paper
          elevation={0}
          sx={{
            width: {md:692,lg:470},
            height: {md:563,lg:550},
        ...
        >
          <Image src={require("../../../../../../assets/ExImgPDList.png")} />
          <Box
            sx={{
              display: "flex",
