     ...
     <ThemeProvider theme={Responsive}>
      ...
      >
        ...
        >
          <Box sx={{ display: "flex" }}>
            <Typography
              sx={{ fontSize: 16, fontWeight: 600, color: "#007DFC" }}className={noto_Sans_Thai.className}
            >
              Smart Medical Cabinet
            </Typography>
            <Typography
              sx={{ fontSize: 16, fontWeight: 500, color: "#5D6471", ml: 1 }}className={noto_Sans_Thai.className}
            >
